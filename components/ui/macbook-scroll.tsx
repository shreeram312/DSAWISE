...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  dark:bg-black flex flex-col items-center py-0 md:py-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      {/* <motion.h2
        style={{
        ...
        className="dark:text-white dark:bg-[#0B0B0F] text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
